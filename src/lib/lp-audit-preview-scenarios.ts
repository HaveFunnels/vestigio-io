...
const COMMON_BLURRED: BlurredFinding[] = [
	...
	mkBlurred("b4", "structure", "3 vazamentos que se reforçam — por que esse leak te custa o dobro"),
	mkBlurred("b5", "cta", "Sua copy quebra no estágio de 'desejo' — 2 elementos AIDA faltando"),
