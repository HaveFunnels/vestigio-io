...
function StreakKpiComponent({ data }: WidgetProps) {
	...
	// Reuse the heatmap caption — it already understands streaks.
	...
	return (
		<div className='relative flex h-full flex-col justify-between overflow-hidden p-5'>
			...
			<div
				className='pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-br from-amber-300/[0.05] via-transparent to-transparent backdrop-blur-md'
				aria-hidden
			/>
			<div
