...
const nextConfig = {
	...
	async headers() {
		...
		const baseCspDirectives = [
			...
			"img-src 'self' data: blob: https://cdn.sanity.io https://*.googleusercontent.com https://*.githubusercontent.com https://*.r2.cloudflarestorage.com https://cdn.vestigio.io https://www.google.com",
			"media-src 'self' https://cdn.vestigio.io",
			"font-src 'self' https://fonts.gstatic.com",
			"connect-src 'self' https://app.vestigio.io https://audit.vestigio.io https://cdn.vestigio.io https://evt.vestigio.io https://www.vestigio.io https://vestigio.io https://*.sanity.io https://*.paddle.com https://*.google-analytics.com wss://*.sanity.io https://cdn.vestigio.io",
		...
		const studioCspDirectives = [
			...
			"media-src 'self' https://cdn.vestigio.io",
			"font-src 'self' https://fonts.gstatic.com",
			"connect-src 'self' https://app.vestigio.io https://audit.vestigio.io https://cdn.vestigio.io https://evt.vestigio.io https://www.vestigio.io https://vestigio.io https://*.sanity.io https://core.sanity-cdn.com https://*.paddle.com https://*.google-analytics.com wss://*.sanity.io https://cdn.vestigio.io",
			"frame-src 'self' https://*.paddle.com https://*.sanity.io",
			"object-src 'none'",
			"base-uri 'self'",
			"form-action 'self'",
