...
const SAAS_BR: PreviewScenario = {
	...
	lead: {
		...
		primaryConcern: "low_trial_to_paid",
		currentOptimizationMethod: "intuition",
		whyNow: "Quero parar de adivinhar o que está furando o funil de trial",
...
const ECOM_BR: PreviewScenario = {
	...
	lead: {
		...
		primaryConcern: "cart_abandonment",
		currentOptimizationMethod: "monthly_audit_agency",
		whyNow: "A taxa de abandono no checkout dobrou nos últimos 60 dias",
...
const COURSE_BR: PreviewScenario = {
	...
	lead: {
		...
		businessModel: "infoproduct",
		monthlyRevenue: 25_000,
		primaryConcern: "low_landing_conversion",
		currentOptimizationMethod: "self_chatgpt",
		whyNow: "Quero rodar um lançamento em 30 dias e a página atual converte 0.4%",
...
const LOADING: PreviewScenario = {
	...
	lead: {
		...
		primaryConcern: "low_trial_to_paid",
		currentOptimizationMethod: "intuition",
		whyNow: "Quero parar de adivinhar",
		emailMasked: "h***@havefunnels.com",
		createdAt: nowIso(),
		result: null,
	},
