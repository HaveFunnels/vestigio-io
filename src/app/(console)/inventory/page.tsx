  ...
  return (
    <div className="sticky top-0 z-30 flex items-center gap-4 rounded-lg border border-edge bg-surface-card px-4 py-2.5 shadow-lg">
      ...
      <button
        ...
        className="ai-border-btn relative isolate rounded-lg bg-black px-3 py-1.5 text-xs font-medium text-white transition-transform hover:scale-[1.02] active:scale-[0.98]"
      >
