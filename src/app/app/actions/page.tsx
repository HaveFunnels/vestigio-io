	...
	return (
		<div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-3">
			<div className="flex items-center gap-2 mb-2">
				...
				<span className="text-[10px] text-content-faint">1 query</span>
			</div>
			...
			{!prompt ? (
				<>
					<p className="text-[11px] text-content-muted mb-2.5">
						Generate a remediation prompt tailored for your AI coding tool.
					</p>
					<div className="flex items-center gap-2">
						<select
							value={selectedTool}
				...
				<>
					<div className="flex items-center justify-between mb-2">
						<span className="text-[11px] text-content-muted">
							Prompt for {AI_TOOLS.find((t) => t.id === selectedTool)?.label || selectedTool}
						</span>
						<div className="flex items-center gap-1.5">
							<button
