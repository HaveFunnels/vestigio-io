	...
	return (
		...
		>
			...
			<div className="relative w-full max-w-[540px]">
				...
				<div className="shiny-card group relative flex min-h-[calc(100dvh-140px)] flex-col overflow-hidden rounded-3xl shadow-[0_0_0_1px_rgba(16,185,129,0.1),0_25px_80px_-20px_rgba(0,0,0,0.35),0_0_50px_-10px_rgba(16,185,129,0.12)] max-h-[680px] sm:min-h-[640px] sm:max-h-[760px]">
					{/* Emerald glow halos */}
