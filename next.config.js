...
const nextConfig = {
	...
	async headers() {
		...
		const baseCspDirectives = [
			...
			"connect-src 'self' https://*.vestigio.io https://*.sanity.io https://*.paddle.com https://*.google-analytics.com wss://*.sanity.io https://cdn.vestigio.io",
		...
		const studioCspDirectives = [
			...
			"media-src 'self' https://cdn.vestigio.io",
			"font-src 'self' https://fonts.gstatic.com",
			"connect-src 'self' https://*.vestigio.io https://*.sanity.io https://core.sanity-cdn.com https://*.paddle.com https://*.google-analytics.com wss://*.sanity.io https://cdn.vestigio.io",
			"frame-src 'self' https://*.paddle.com https://*.sanity.io",
			"object-src 'none'",
			"base-uri 'self'",
			"form-action 'self'",
