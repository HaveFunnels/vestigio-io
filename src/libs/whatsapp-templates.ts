...
export const WHATSAPP_TEMPLATES: Record<WhatsAppLanguage, Record<string, WhatsAppTemplateDef>> = {
	pt_BR: {
		...
		vestigio_regression: {
			...
			button: { type: "URL", text: "Ver mudanças", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_page_down: {
			...
			button: { type: "URL", text: "Ver incidente", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_magic_link: {
	...
	en_US: {
		vestigio_incident: {
			...
			params: ["domain", "headline", "root_cause_summary"],
			button: { type: "URL", text: "Open in Vestigio", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_regression: {
			name: "vestigio_regression",
			category: "UTILITY",
			...
			params: ["domain", "headline", "count"],
			button: { type: "URL", text: "View changes", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_page_down: {
			name: "vestigio_page_down",
			category: "UTILITY",
			...
			params: ["page_url", "status_code"],
			button: { type: "URL", text: "View incident", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_magic_link: {
			name: "vestigio_magic_link",
			category: "AUTHENTICATION",
	...
	es_LA: {
		vestigio_incident: {
			...
			params: ["domain", "headline", "root_cause_summary"],
			button: { type: "URL", text: "Abrir en Vestigio", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_regression: {
			name: "vestigio_regression",
			category: "UTILITY",
			...
			params: ["domain", "headline", "count"],
			button: { type: "URL", text: "Ver cambios", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_page_down: {
			name: "vestigio_page_down",
			category: "UTILITY",
	...
	de: {
		vestigio_incident: {
			...
			params: ["domain", "headline", "root_cause_summary"],
			button: { type: "URL", text: "In Vestigio öffnen", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_regression: {
			name: "vestigio_regression",
			category: "UTILITY",
			...
			params: ["domain", "headline", "count"],
			button: { type: "URL", text: "Änderungen anzeigen", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_page_down: {
			name: "vestigio_page_down",
			category: "UTILITY",
			...
			params: ["page_url", "status_code"],
			button: { type: "URL", text: "Vorfall anzeigen", url: "https://vestigio.io/app/analysis" },
		},
		vestigio_magic_link: {
			name: "vestigio_magic_link",
			category: "AUTHENTICATION",
