...
export const INFERENCE_TO_PACK: Record<string, string> = {
  ...
  credentials_not_visible: 'vertical_specific',
  no_consultation_cta: 'vertical_specific',
  team_expertise_invisible: 'vertical_specific',
  no_proof_of_result: 'vertical_specific',
  guarantee_invisible: 'vertical_specific',
  no_payment_options: 'vertical_specific',
  no_curriculum_visible: 'vertical_specific',
