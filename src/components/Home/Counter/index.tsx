					...
					<div className='hidden flex-col gap-3 sm:gap-4 lg:flex'>
						...
						<div className='relative flex flex-1 flex-col items-center justify-center overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8'>
							...
							<div className='pointer-events-none absolute inset-0 flex items-center justify-center'>
								<div className='h-[180px] w-[180px] rounded-full border border-dashed border-emerald-500/[0.08]' style={{ animation: 'vcounter-pulse-ring 5s ease-in-out infinite' }} />
								<div className='absolute h-[260px] w-[260px] rounded-full border border-dashed border-violet-500/[0.06]' style={{ animation: 'vcounter-pulse-ring 5s ease-in-out infinite 1.5s' }} />
								<div className='absolute flex h-16 w-16 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.04]'>
									<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.4' className='h-7 w-7 text-emerald-400'>
								...
								{/* Orbiting dots */}
								<div className='absolute h-2.5 w-2.5 rounded-full bg-emerald-400/50 shadow-[0_0_8px_rgba(16,185,129,0.4)]' style={{ top: '18%', right: '30%', animation: 'vcounter-float 3s ease-in-out infinite 0.3s' }} />
								<div className='absolute h-2 w-2 rounded-full bg-violet-400/40 shadow-[0_0_8px_rgba(139,92,246,0.3)]' style={{ bottom: '22%', left: '28%', animation: 'vcounter-float 3.5s ease-in-out infinite 1s' }} />
								<div className='absolute h-2 w-2 rounded-full bg-amber-400/40 shadow-[0_0_8px_rgba(251,191,36,0.3)]' style={{ top: '35%', left: '20%', animation: 'vcounter-float 4s ease-in-out infinite 2s' }} />
							</div>
