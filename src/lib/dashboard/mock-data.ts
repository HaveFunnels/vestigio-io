	...
	return {
		...
		actionQueue: {
			items: [
				{
					id: "mock-aq-1",
					title: "Adicionar headers CSP no /checkout",
					severity: "critical",
					impactMidpointCents: 241000,
					status: "pending",
					effortHint: "low",
				...
				{
					id: "mock-aq-2",
					title: "Reescrever hero do /pricing — A/B com a versão B",
					severity: "high",
					impactMidpointCents: 124000,
					status: "in_progress",
					effortHint: "medium",
					createdAt: "2026-05-28T16:00:00Z",
					assigneeName: "Luís Galletto",
				},
				{
					id: "mock-aq-3",
					title: "Configurar DMARC com p=quarantine no domínio principal",
					severity: "high",
					impactMidpointCents: 89000,
					status: "pending",
					effortHint: "trivial",
				...
				{
					id: "mock-aq-4",
					title: "Adicionar FAQ de frete na home + página de produto",
					severity: "medium",
					impactMidpointCents: 56000,
					status: "pending",
					effortHint: "low",
				...
				{
					id: "mock-aq-5",
					title: "Substituir CTA 'Saiba mais' por 'Começar grátis'",
					severity: "medium",
					impactMidpointCents: 42000,
					status: "in_progress",
					effortHint: "trivial",
			...
			totalOpen: 12,
			totalImpactCents: 689000,
			currency: "BRL",
			caption: "12 ações abertas — R$ 6,9k/mês em foco",
		},
	};
}
...
export const MOCK_DASHBOARD_DATA: DashboardData = {
	...
	actionQueue: {
		items: [
			{
				id: "demo-aq-1",
				title: "Add CSP headers to /checkout",
				severity: "critical",
				impactMidpointCents: 241000,
				status: "pending",
				effortHint: "low",
				createdAt: "2026-05-30T10:00:00Z",
				assigneeName: "Mariana",
			},
			{
				id: "demo-aq-2",
				title: "Rewrite /pricing hero — A/B with variant B",
				severity: "high",
				impactMidpointCents: 124000,
				status: "in_progress",
				effortHint: "medium",
			...
			{
				id: "demo-aq-3",
				title: "Configure DMARC p=quarantine on primary domain",
				severity: "high",
				impactMidpointCents: 89000,
				status: "pending",
				effortHint: "trivial",
		...
		totalOpen: 8,
		totalImpactCents: 569000,
		currency: "USD",
		caption: "8 open actions — $5.7k/mo focused",
	},
};
