					...
					<div className='vclient-track flex w-max items-center gap-x-12 sm:gap-x-16'>
						{loopLogos.map((logo, i) => (
							<img
								...
								title={logo.name}
								loading="lazy"
								className="h-6 w-auto max-w-[100px] shrink-0 object-contain brightness-0 invert opacity-40 transition-opacity duration-300 hover:opacity-70 sm:h-7 sm:max-w-[120px]"
							/>
						))}
					</div>
				</div>
