...
export const InferenceKey = {
  ...
  AlternateFlowsUnmeasured: 'alternate_flows_unmeasured',
  ...
  ChannelCompromiseVisible: 'channel_compromise_visible',
  /** From packs/channel-integrity.ts */
  ChannelTrafficDivertible: 'channel_traffic_divertible',
  ...
  /** From packs/scale-readiness.ts */
  CheckoutIntegrity: 'checkout_integrity',
  /** From packs/evidence-derived.ts */
  CheckoutProviderFragmented: 'checkout_provider_fragmented',
  /** From packs/evidence-derived.ts */
  CheckoutProviderPathWeak: 'checkout_provider_path_weak',
  /** From packs/security-posture.ts */
  CheckoutScriptHijackRisk: 'checkout_script_hijack_risk',
  /** From packs/channel-integrity.ts */
  CheckoutTrustBrittleInfrastructure: 'checkout_trust_brittle_infrastructure',
  /** From packs/copy-alignment.ts */
  CheckoutTrustLanguageAbsent: 'checkout_trust_language_absent',
  /** From packs/scale-readiness.ts */
  CommerceContext: 'commerce_context',
  /** From packs/channel-integrity.ts */
  CommerceOperationsExposed: 'commerce_operations_exposed',
  /** From packs/evidence-derived.ts */
  CommercialJourneyLanguageBreak: 'commercial_journey_language_break',
  /** From packs/content-freshness.ts */
  CommercialPageStale: 'commercial_page_stale',
  /** From packs/evidence-derived.ts */
  CommercialPagesDisconnected: 'commercial_pages_disconnected',
  /** From packs/discoverability.ts */
  ...
  /** From packs/channel-integrity.ts */
  CommercialPathAbuseFriendly: 'commercial_path_abuse_friendly',
  /** From packs/evidence-derived.ts */
  ConsentUnderminingMeasurement: 'consent_undermining_measurement',
  /** From packs/content-freshness.ts */
  ...
  /** From packs/copy-alignment.ts */
  CtaClarityWeakOnCommercial: 'cta_clarity_weak_on_commercial',
  /** From packs/behavioral.ts */
  ...
  /** From packs/channel-integrity.ts */
  EconomicExploitationActive: 'economic_exploitation_active',
  /** From packs/security-posture.ts */
  EmailDeliverabilityRisk: 'email_deliverability_risk',
  /** From packs/security-posture.ts */
  ErrorPageInformationLeak: 'error_page_information_leak',
  /** From packs/chargeback-resilience.ts */
  ExpectationMisalignment: 'expectation_misalignment',
  /** From packs/brand-integrity.ts */
  ...
  /** From packs/evidence-derived.ts */
  FormDataLeavesDomain: 'form_data_leaves_domain',
  /** From packs/copy-alignment.ts */
  ...
  /** From packs/revenue-integrity.ts */
  FrictionOnCriticalPath: 'friction_on_critical_path',
  /** From packs/behavioral.ts */
  ...
  /** From packs/evidence-derived.ts */
  HighIntentSurfacesBlind: 'high_intent_surfaces_blind',
  /** From packs/commerce-context.ts */
  ...
  /** From packs/evidence-derived.ts */
  MobileCommercialPathBlocked: 'mobile_commercial_path_blocked',
  /** From packs/behavioral.ts */
  ...
  /** From packs/evidence-derived.ts */
  MobileTrustWeakerThanDesktop: 'mobile_trust_weaker_than_desktop',
  /** From packs/monetization-extensions.ts */
  ...
  /** From packs/channel-integrity.ts */
  PaymentSurfaceCompromised: 'payment_surface_compromised',
  /** From packs/monetization-extensions.ts */
  PixelCoverageGap: 'pixel_coverage_gap',
  /** From packs/evidence-derived.ts */
  PlatformCheckoutRiskUnaddressed: 'platform_checkout_risk_unaddressed',
  /** From packs/behavioral.ts */
  ...
  /** From packs/evidence-derived.ts */
  PostPurchaseConfirmationAbsent: 'post_purchase_confirmation_absent',
  /** From packs/evidence-derived.ts */
  PostPurchaseProofTooWeak: 'post_purchase_proof_too_weak',
  /** From packs/security-posture.ts */
  ...
  /** From packs/security-posture.ts */
  RateLimitingAbsentOnCommerce: 'rate_limiting_absent_on_commerce',
  /** From packs/evidence-derived.ts */
  ReassuranceRoutesDisconnected: 'reassurance_routes_disconnected',
  /** From packs/evidence-derived.ts */
  RedirectChainErodesCheckoutTrust: 'redirect_chain_erodes_checkout_trust',
  /** From packs/chargeback-resilience.ts */
  RefundPolicyGap: 'refund_policy_gap',
  /** From packs/evidence-derived.ts */
  RefundProcessUnclear: 'refund_process_unclear',
  /** From packs/evidence-derived.ts */
  RefundTermsTooThin: 'refund_terms_too_thin',
  /** From packs/monetization-extensions.ts */
  RevenueAttributionMismatch: 'revenue_attribution_mismatch',
  /** From packs/revenue-integrity.ts */
  RevenueLeakage: 'revenue_leakage',
  /** From packs/scale-readiness.ts */
  RevenuePathFragile: 'revenue_path_fragile',
  /** From packs/evidence-derived.ts */
  RuntimeBreakingReassurance: 'runtime_breaking_reassurance',
  /** From packs/evidence-derived.ts */
  RuntimeErrorsInterruptPurchase: 'runtime_errors_interrupt_purchase',
  /** From packs/evidence-derived.ts */
  RuntimeMeasurementBroken: 'runtime_measurement_broken',
  /** From packs/wave-4-extensions.ts */
  SaasActivationGapHeuristic: 'saas_activation_gap_heuristic',
  /** From packs/wave-4-extensions.ts */
  ScriptSupplyChainRisk: 'script_supply_chain_risk',
  /** From packs/evidence-derived.ts */
  SecondaryFlowsBypassTrustPath: 'secondary_flows_bypass_trust_path',
  /** From packs/security-posture.ts */
  ...
  /** From packs/evidence-derived.ts */
  SupportHiddenAtPurchase: 'support_hidden_at_purchase',
  /** From packs/evidence-derived.ts */
  ...
  /** From packs/evidence-derived.ts */
  TrackingStackGaps: 'tracking_stack_gaps',
  /** From packs/channel-integrity.ts */
  TrafficLandingLowTrustPosture: 'traffic_landing_low_trust_posture',
  /** From packs/evidence-derived.ts */
  TrustAndMeasurementBothAbsent: 'trust_and_measurement_both_absent',
  /** From packs/network-analysis.ts */
  ...
  /** From packs/revenue-integrity.ts */
  UnclearConversionIntent: 'unclear_conversion_intent',
  /** From packs/evidence-derived.ts */
  UntrustedEmbedsNearPurchase: 'untrusted_embeds_near_purchase',
  /** From packs/copy-alignment.ts */
